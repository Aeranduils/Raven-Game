...
public:
    ...
    //this method is called when the user clicks the middle mouse button
    //The method gives a possessed bot a target, and will try to shoot at it
    ...
    //when called will send the headquarters position
    Vector2D        GetHQposition();
