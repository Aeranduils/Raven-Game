...
void RocketLauncher::InitializeFuzzyModule()
{
    ...
    FzSet& Target_Very_Close = DistToTarget.AddLeftShoulderSet("Target_Close", 0, 10, 25);
    ...
    FzSet& Target_Very_Far = DistToTarget.AddRightShoulderSet("Target_Far", 300, 1000, 1500);

    FuzzyVariable& Desirability = m_FuzzyModule.CreateFLV("Desirability");
    FzSet& Necessity = Desirability.AddRightShoulderSet("Necessity", 75, 85, 100);
    ...
    FzSet& Banned = Desirability.AddLeftShoulderSet("Banned", 0, 5, 10);

    FuzzyVariable& AmmoStatus = m_FuzzyModule.CreateFLV("AmmoStatus");
    FzSet& Ammo_Full = AmmoStatus.AddRightShoulderSet("Ammo_Loads", 30, 50, 100);
    FzSet& Ammo_Loads = AmmoStatus.AddTriangularSet("Ammo_Loads", 10, 30, 75);
    FzSet& Ammo_Okay = AmmoStatus.AddTriangularSet("Ammo_Okay", 0, 10, 30);
    FzSet& Ammo_Low = AmmoStatus.AddTriangularSet("Ammo_Low", 0, 0, 10);
    FzSet& Ammo_Empty = AmmoStatus.AddTriangularSet("Ammo_Low", 0, 0, 0);
    ...
    m_FuzzyModule.AddRule(FzAND(Target_Very_Close, Ammo_Low), Banned);
    m_FuzzyModule.AddRule(FzAND(Target_Very_Close, Ammo_Empty), Banned);

    m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Full), Desirable);
    ...
    m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Empty), Banned);

    m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Full), Necessity);
    m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Loads), Necessity);
    ...
    m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Empty), Banned);
    ...
    m_FuzzyModule.AddRule(FzAND(Target_Far, Ammo_Empty), Banned);
    ...
    m_FuzzyModule.AddRule(FzAND(Target_Very_Far, Ammo_Empty), Banned);
}
